...
> Åbn denne side på [https://horsboll.github.io/track-bil/](https://horsboll.github.io/track-bil/)
...
* søg efter **https://github.com/horsboll/track-bil**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/horsboll/track-bil/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/horsboll/track-bil**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/horsboll/track-bil/raw/master/.github/makecode/blocks.png)
